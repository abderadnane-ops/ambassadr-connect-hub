    ...
    <div className="min-h-screen bg-white text-[#2a1020] font-body overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-14">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* White overlay — video ~75% visible */}
          <div className="absolute inset-0 bg-white/25" />
          <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-white/25 to-white" />
        </div>

        {/* Hero Content — with text-shadow and backdrop for readability */}
        <div className="relative z-10 max-w-3xl mx-auto px-5 text-center space-y-6 py-20">
          {/* Frosted glass backing for text readability */}
          <div className="absolute inset-0 -mx-2 rounded-3xl bg-white/60 backdrop-blur-sm" />
          
          <div className="relative">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#A6CE39]/15 border border-[#A6CE39]/30 text-[#4a7a08] text-xs font-medium tracking-wider uppercase">
              <Sparkles className="w-3.5 h-3.5" />
              Réseau des Ambassadeurs Citoyens
            </div>

            <h1 className="font-display text-5xl sm:text-7xl font-bold tracking-tight leading-[0.95] text-[#722D50] mt-6 drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)]">
              CIT<span className="text-[#A6CE39]">I</span>ZEN
            </h1>

            <p className="text-lg sm:text-xl text-[#722D50]/80 font-light max-w-xl mx-auto leading-relaxed mt-6">
              La plateforme numérique du réseau des Ambassadeurs Citoyens
            </p>

            <p className="text-sm sm:text-base text-[#722D50]/50 italic max-w-lg mx-auto mt-4">
              One Network. Twelve Regions. A New Generation of Civic Leadership.
            </p>

            <p className="text-sm text-[#2a1020]/70 max-w-md mx-auto leading-relaxed mt-4">
            ...
            <p className="text-xs text-[#722D50]/40 tracking-wide mt-4">
              Une initiative du mouvement <span className="text-[#A6CE39] font-medium">Les Citoyens</span> — Mieux vivre ensemble
            </p>
            ...
            <div className="pt-6 space-y-3">
              ...
              <p className="text-[11px] text-[#722D50]/40">
