import { MapPin, Briefcase, Calendar, Flame, Award } from "lucide-react";
    ...
    <div className="relative overflow-hidden rounded-2xl gradient-hero p-5 text-primary-foreground animate-fade-in">
      ...
      <div className="relative z-10 flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h1 className="font-display text-xl font-bold mt-0.5">Amina 👋</h1>
          <div className="flex items-center gap-1.5 mt-1 text-white/70 text-xs">
            <MapPin className="w-3 h-3" />
            <span>Réseau Rabat-Salé-Kénitra</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1.5 shrink-0 transition-transform duration-200 hover:scale-105">
          <Flame className="w-4 h-4 text-highlight animate-pulse-glow" />
          <span className="text-xs font-bold">12j</span>
        </div>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-3 gap-3 mt-5">
        <div className="bg-white/15 backdrop-blur-sm rounded-xl p-3 text-center transition-transform duration-200 hover:scale-105 hover:bg-white/20">
          <Briefcase className="w-4 h-4 mx-auto mb-1 text-highlight" />
          <p className="font-display font-bold text-lg leading-none">3</p>
          <p className="text-[10px] text-white/70 mt-0.5">Opportunités</p>
        </div>
        <div className="bg-white/15 backdrop-blur-sm rounded-xl p-3 text-center transition-transform duration-200 hover:scale-105 hover:bg-white/20">
          <Calendar className="w-4 h-4 mx-auto mb-1 text-secondary" />
          <p className="font-display font-bold text-lg leading-none">Ven</p>
          <p className="text-[10px] text-white/70 mt-0.5">Prochain evt.</p>
        </div>
        <div className="bg-white/15 backdrop-blur-sm rounded-xl p-3 text-center transition-transform duration-200 hover:scale-105 hover:bg-white/20">
          <Award className="w-4 h-4 mx-auto mb-1 text-white" />
          <p className="font-display font-bold text-lg leading-none">2450</p>
          <p className="text-[10px] text-white/70 mt-0.5">Points</p>
        </div>
      </div>
      ...
      <div className="relative z-10 mt-4 bg-white/10 backdrop-blur-sm rounded-lg px-3.5 py-2.5 flex items-center gap-3 transition-all duration-200 hover:bg-white/15">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[10px] text-white/60">Prochain événement</p>
          <p className="text-sm font-semibold line-clamp-1">Formation Civique — Vendredi 14:00</p>
        </div>
      </div>
    </div>
  );
